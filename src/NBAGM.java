...
public class NBAGM
{
    public static void main(String[] args) throws IOException
    {
  	...
  	while(inScan.hasNextLine()&&count<=699)
  	{
	  	...
	  	/*
	  	if(skills1.equals("N/A"))skills1=" ";
	  	else
	  	{
	  		if(skills2.equals("N/A") && skills3.equals("N/A"))
	  			skills1="\""+skills1+"\"";
	  		if(skills2.equals("N/A") && (!(skills3.equals("N/A"))))
	  			skills1="\""+skills1+"\",";
	  		if(!(skills2.equals("N/A")))
	  			skills1="\""+skills1+"\",";
	  	}
	  	if(skills2.equals("N/A"))skills2=" ";
	  	else
	  	{
	  		if(skills3.equals("N/A"))
	  			skills2="\""+skills2+"\"";
	  		if(!(skills3.equals("N/A")))
	  			skills2="\""+skills2+"\",";
	  	}
	  	if(skills3.equals("N/A")){skills3=" ";}else{skills3="\""+skills3+"\"";}*/
